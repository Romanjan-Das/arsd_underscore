...
function underscore_scripts() {
	...
	wp_register_style('custom-style',get_template_directory_uri().'/custom-css/custom-style.css',array(),false,'all');
	wp_enqueue_style('custom-style');

	wp_register_script('custom-script',get_template_directory_uri().'/custom-js/custom-script.js','',1,true);
